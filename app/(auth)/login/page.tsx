    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex flex-col justify-center px-10 md:px-24 bg-white">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">Login and get started with Blocstage!</p>
        </div>
        ...
        <p className="text-center mt-6 text-gray-600 text-sm">
          ...
          <a href={pageRoutes.signup} className="text-[#f4511e] font-semibold">
            Sign up
          </a>
        </p>
        {/* Sign In Link */}
        <p className="text-center mt-6 text-gray-600 text-sm">
          ...
          <a href={pageRoutes.forgotPassword} className="text-[#f4511e] font-semibold">
            Forgot Password
          </a>
        </p>
      </div>
