  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push(pageRoutes.emailSent); // Redirect to OTP page
      } else {
    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex flex-col justify-center px-10 md:px-24 bg-white">
            ...
            <>
              ...
              <div>
                ...
                <select
                  ...
                  value={form.country}
                  onChange={handleChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-md text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all"
                  required
                >
        ...
        <p className="text-center mt-6 text-gray-600 text-sm">
          ...
          <a href={pageRoutes.login} className="text-[#f4511e] font-semibold">
            Sign In
          </a>
        </p>
      </div>
