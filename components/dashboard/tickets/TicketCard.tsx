...
import { EllipsisVertical, Edit, Trash2, Copy, QrCode } from "lucide-react";
  ...
  return (
    <div className="max-w-[706px] bg-white rounded-[8px] sm:rounded-[16px] px-3 sm:px-[18px] py-4">
      ...
      <div className="max-sm:text-center flex max-sm:flex-col sm:justify-between sm:items-end  sm:gap-[50px] lg:gap-[100px]">
        ...
        <div className=" max-sm:justify-between sm:justify-end max-sm:w-full bg-red300 flex max-sm:mx-auto items-end gap-2 max-sm:mt-4">
          <div>
